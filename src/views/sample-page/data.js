export const disasters = [
    {
      ...
      "DOs": [
            ...
            "if in moving vehicle, stop as quickly as safety permits and stay in the vehicle.",
            ],
    ...
    },
    {
      ...
      "pre": [
        ...
        "Store water because the water supply may be disrupted during cyclones."
      ],
      "DOs": [
        "Be aware of the official cyclone warning by listening to the radio or other authentic sources.",
        "Install storm shutters or board up glass windows.",
        "Keep all the doors and windows closed. Move to a house built on high grounds.",
        ...
        "Other than this, if the eye of the cyclone passes over your house, you should strictly avoid doing some activities as follows -If you are asked to evacuate, do not hesitate.",
        "Switch off the electrical mains in your house.",
        "Avoid rumours of any sort."
      ],
      "DONTs": [
      ...
      "post": [
        ...
        "Stay in the shelter until you receive proper information regarding safety in moving outside.",
        "Drive your car carefully after the cyclone passes.",
        ...
        "Do not use tap water for drinking or cooking as the sewerage lines may be contaminated"
      ]
    },
    {
      "id" : "3",
      ...
      "DOs": [
        "Watch your step- Stay away from sewerage lines, gutte rs, drains, culverts, etc.",
        ...
        "Bware of puddles and open drains"
      ],
      "DONTs": [
    ...
    },
    {
      ...
      "DOs": [
        ...
        "Make judicious use of available water.",
        "Ensure availability of agricultural inputs.",
        "Wash clothes/utencils using as les water as possible."
      ],
      "DONTs": [
